...
<html>
    ...
    <body>
        ...
        <div class="col-12 right_content" style="text-align: center;">
            <form action="PHP/insertRegister.php" method="GET" >
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="form__group col-md-12">
                            <span> 
                                <input class="balloon" id="state" type="text" name ="name" value="" placeholder="" />
                                <label for="state">Firts Name</label> 
                            </span> 
                        </div>
                        <div class="form_group col-md-12">
                            <span> 
                                <input class="balloon" id="state" type="text" name="last_name" value="" placeholder="" />
                                <label for="state">Last Name</label> 
                            </span> 
                        </div>
                        <div class="form_group col-md-12">
                            <span> 
                                <input class="balloon" id="state" name="username" type="text" value="" placeholder="" />
                        ...
                        <div class="form_group col-md-12">
                            <span> 
                                <input class="balloon" id="state" type="password" name="password" value="" placeholder="" />
